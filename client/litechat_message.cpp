...
void LiteChat_Message::setTextSuccess()
{
    m_loading->hide();
    m_loadingMovie->stop();
    m_isSending = true;
...
void LiteChat_Message::setText(QString text, QString time, QSize allSize, LiteChat_Message::User_Type userType)
{
    m_msg = text;
    m_userType = userType;
    m_time = time;
...
QSize LiteChat_Message::getRealString(QString src)
{
...
void LiteChat_Message::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event);
