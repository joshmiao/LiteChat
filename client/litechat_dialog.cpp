...
LiteChat_Dialog::LiteChat_Dialog(LiteChat_Server *liteChatServer, QString dialogName, LiteChat_Dialog::Dialog_Type dialogType, int32_t toId, QWidget *parent) :
    QWidget(parent),
...
{
    LiteChat_InviteFriend *invitePage = liteChatServer->createInvitePage(toId);
    invitePage->show();
}
